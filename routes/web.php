...
Route::get('/', [App\Http\Controllers\report\Dashboard3Controller::class, 'index'])->name('index');


Route::get('/loginForm', [App\Http\Controllers\report\Dashboard3Controller::class, 'loginForm'])->name('loginForm');
Route::get('/loginForm/{formName}', [App\Http\Controllers\report\Dashboard3Controller::class, 'loginForm'])->name('loginForm_byname');

Route::get('/forgetPassword', [App\Http\Controllers\report\Dashboard3Controller::class, 'forgetPassword'])->name('forgetPassword');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/home', [App\Http\Controllers\report\Dashboard3Controller::class, 'home'])->name('home');
