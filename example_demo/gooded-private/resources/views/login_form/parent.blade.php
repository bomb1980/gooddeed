...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="html/css/cd-swiper.css?9114">
...
<body>
    ...
    <div class="page-container">
        ...
        <!-- bloc-30 -->
        <div class="bloc tc-7996 bloc-fill-screen cardfit3 bgc-1974 bloc-bg-texture texture-geometry-shapes-2 d-bloc"
            id="bloc-30">
            <div class="container">
                <div class="row row-32-style align-items-center">
                    <div class="col-md-3 offset-md-7 col-sm-4 offset-sm-7 offset-lg-7 col-lg-2 col-7 offset-5">
                        <h3 class="mg-sm text-lg-right btn-resize-mode h3-style text-sm-right text-right">
                            <span class="feather-icon icon-reply icon-4645"></span> <a class="h3-style"
                                href="{{ route('loginForm') }}">กลับไปยังสถานะใหม่</a><br>
                        </h3>
                    </div>
                    <div
                        class="col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-12 offset-0 cardadmin2">
                        <img src="html/img/lazyload-ph.png" data-src="html/img/good_login2.svg"
                            ...
                            <div class="row align-items-start">
                                <div
                                    ...
                                    <div class="form-group text-center text-sm-center">
                                        ...
                                        <input class="form-control field-style" type="password" placeholder="รหัสผ่าน"
                                            id="input_2723" required="">  --}}
...
<br>
                                            ...
                                            {{--  <a href="html/parent/dashboard-parent.php"
                                            class="btn btn-d btn-lg btn-ยืนยัน-style">ตกลง<br></a>  --}}


                                    </div>
                                </div>
                                <div
                                    class="wodx align-self-center col-12 offset-0 offset-sm-1 col-sm-10 col-lg-10 offset-lg-1 col-md-10 offset-md-1">
                                    <div class="form-group text-center container-div-style text-sm-center">
                                        <div class="row">
                                            <div class="col-5 offset-1 offset-md-0">
                                                <h1
                                                    class="mg-clear text-md-center text-center btn-resize-mode mg-clear-md text-sm-left text-lg-left">
                                                    <a class="h1-สมัครสมาชิก-style"
                                                        href="{{ $register_link }}">สมัครสมาชิก</a><br>
                                                </h1>
                                            </div>
                                            <div class="col">
                                                <h1
                                                    class="mg-clear text-center mg-clear-md text-sm-right text-lg-right h1-ลืมรหัสผ่าน-style text-md-right">
                                                    <a class="h1-ลืมรหัสผ่าน-style" href="{{route('forgetPassword')}}"
                                                        target="_blank">ลืมรหัสผ่าน</a><br>
                                                </h1>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="html/js/cd-swiper.min.js?7557"></script>
    <script src="html/js/mresize.js?5159"></script>
    <script src="html/js/card-designer.js?1913"></script><!-- Additional JS END -->
