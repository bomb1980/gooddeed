...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="html/css/cd-swiper.css?7075">
...
<body>
    ...
    <div class="page-container">
        ...
        <!-- bloc-29 -->
        <div class="bloc tc-7996 bloc-fill-screen bgc-4032 bloc-bg-texture texture-geometry-shapes-2 d-bloc"
            id="bloc-29">
            <div class="container">
...
<br>
                                            ...
                                            <div class="col-5 offset-1 offset-md-0">
                                                <h1
                                                    ...
                                                    <a class="h1-สมัครสมาชิก-style"
                                                        href="html/student/register-student.php">สมัครสมาชิก</a><br>
                                                </h1>
                                            </div>
                                            <div class="col">
                                                <h1
    ...
    <script src="html/js/cd-swiper.min.js?9601"></script>
    <script src="html/js/mresize.js?4916"></script>
    <script src="html/js/card-designer.js?1788"></script><!-- Additional JS END -->
