...
<head>
	...
	<link rel="stylesheet" type="text/css" href="html/css/cd-swiper.css?7654">
...
<!-- bloc-23 -->
<div class="bloc tc-7996 bloc-fill-screen cardfit3 bgc-6095 d-bloc" id="bloc-23">
	<div class="container">
		<div class="row row-32-style align-items-center">
			<div class="col-md-3 offset-md-7 col-sm-4 offset-sm-7 offset-lg-7 col-lg-2 col-7 offset-5">
				<h3 class="mg-sm text-lg-right btn-resize-mode h3-style text-sm-right text-right">
					<span class="feather-icon icon-reply icon-2771"></span> <a class="h3-style" href="html/Status/status.php">กลับไปยังสถานะใหม่</a><br>
				</h3>
			</div>
			<div class="col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-12 offset-0 cardadmin2">
				<img src="html/img/lazyload-ph.png" data-src="html/img/good_login1-1.svg" class="img-fluid mx-auto d-block img-43-style lazyload" alt="mail" width="45" height="42">
...
<script src="html/js/cd-swiper.min.js?9356"></script>
<script src="html/js/mresize.js?5368"></script>
<script src="html/js/card-designer.js?9686"></script><!-- Additional JS END -->
