...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/cd-swiper.css?7770">
				...
				<div class="row align-items-start">
					<div class="wodx align-self-center col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-8 offset-2 col-sm-8 offset-sm-2">
						<div class="form-group text-center text-sm-center">
							<input class="form-control field-style" type="email" data-error-validation-msg="Not a valid email address" placeholder="รหัสผ่าน" required="">
							<input class="form-control field-style" type="password" placeholder="ยืนยันรหัสผ่าน" id="input_2723" required="">
							<div class="text-center">
								<a href="#" class="btn btn-d btn-lg btn-11-style" data-toggle="modal" data-target="#modal-8975">ตกลง<br></a>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="card-body-style modal-body">
								...
								<div class="row">
									<div class="offset-lg-4 col-lg-4">
										<a href="#" class="btn btn-clean btn-d btn-sq btn-lg btn-14-style" data-toggle="modal" data-target="#modal-8975">ตกลง</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="modal-dialog  modal-dialog-centered" role="document">
						<div class="bgc-3252 modal-content">
							<div class="card-body-style modal-body">
								...
								<div class="row">
									<div class="offset-lg-4 col-lg-4">
										<a href="#" class="btn btn-clean btn-d btn-sq btn-lg btn-14-style" data-toggle="modal" data-target="#modal-31907">ตกลง</a>
									</div>
								</div>
							</div>
						</div>
...
<script src="../js/cd-swiper.min.js?1361"></script>
<script src="../js/mresize.js?1561"></script>
<script src="../js/card-designer.js?994"></script><!-- Additional JS END -->
